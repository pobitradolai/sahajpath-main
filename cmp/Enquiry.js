...
export default function Enquiry() {
    ...
    const [fatherTextErr, setFatherTextErr] = useState(false)
    const [fatherOccupationErr, setFatherOccupationErr] = useState(false)
    const [fatherOccupationValidErr, setFatherOccupationValidErr] = useState(false)
    const [casteErr, setCasteErr] = useState(false)
    const [addressErr, setAddressErr] = useState(false)
    const [addressLenghtErr, setAddressLenghtErr] = useState(false)
    const [pinCodeErr, setPinCodeErr] = useState(false)
    const [pinCodeValidErr, setPinCodeValidErr] = useState(false)
    const [emailErr, setEmailErr] = useState(false)
    const [emailValidErr, setEmailValidErr] = useState(false)
    const [mobileNoErr, setMobileNoErr] = useState(false)
    const [mobileNoValidErr, setMobileNoValidErr] = useState(false)
    const [anotherMobileNoErr, setAnotherMobileNoErr] = useState(false)
    const [anotherMobileValidNoErr, setAnotherMobileValidNoErr] = useState(false)
    const [whatsappNoErr, setWhatsappNoErr] = useState(false)
    const [whatsappValidNoErr, setWhatsappValidNoErr] = useState(false)
    ...
    const [descriptionLenghtErr, setDescriptionLenghtErr] =useState(false)
    ...
    const onSubmit = () => {
        ...
        setFatherTextErr(false)
        setFatherOccupationErr(false)
        setFatherOccupationValidErr(false)
        setCasteErr(false)
        setAddressErr(false)
        setAddressLenghtErr(false)
        setPinCodeErr(false)
        setEmailErr(false)
        setEmailValidErr(false)
        setMobileNoErr(false)
        setMobileNoValidErr(false)
        setAnotherMobileNoErr(false)
        setAnotherMobileValidNoErr(false)
        setWhatsappNoErr(false)
        setWhatsappValidNoErr(false)
        ...
        if (fatherName.trim()) {
            if (!fatherName.trim().match(textformat)) {
                setFatherTextErr(true)
                err++
            }
        }
        ...
        if (fatherOccupation.trim()) {
            if (!fatherOccupation.trim().match(textformat)) {
                setFatherOccupationValidErr(true)
                err++
            }
        }
        if (caste == '') {
        ...
        if (pinCode.trim()) {
            if (!pinCode.trim().match(numberformat)) {
                setPinCodeValidErr(true)
                err++
            }
        }
        if (email.trim() == '') {
        ...
        if (mobileNo.trim()) {
            if (!mobileNo.trim().match(numberformat)) {
                setMobileNoValidErr(true)
                err++
            }
        }
        if (anotherMobileNo == '') {
        ...
        if (anotherMobileNo.trim()) {
            if (!anotherMobileNo.trim().match(numberformat)) {
                setAnotherMobileValidNoErr(true)
                err++
            }
        }
        if (whatsappNo == '') {
        ...
        if (whatsappNo.trim()) {
            if (!whatsappNo.trim().match(numberformat)) {
                setWhatsappValidNoErr(true)
                err++
            }
        }
                        ...
                        <div className='enquiry-form'>
                            ...
                            <div className='enquiry-body'>
                                <div className='row'>
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                            ...
                                            </div>
                                            {
                                             ...
                                             {
                                                textErr ? <div className='color-red font-size-14'>Enter Valid Text Not Number</div> : null
                                            }
                                        </div>
                                    </div>
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                            ...
                                            {
                                                fatherTextErr ? <span className='color-red font-size-14'>Enter the father's name Text Not Number</span> : null
                                    ...
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                            ...
                                            {
                                                fatherOccupationValidErr ? <span className='color-red font-size-14'>Enter the father's occupation Text</span> : null
                                    ...
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                            ...
                                            {
                                                addressLenghtErr ? <div className='color-red font-size-14'>Enter Minimum Value 15</div> : null
                                            }
                                        </div>
                                    </div>
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                            ...
                                            {
                                                pinCodeValidErr ? <div className='color-red font-size-14'>Enter Valid Number Code</div> : null
                                            }
                                        </div></div>
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                    ...
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                            ...
                                            {
                                                mobileNoValidErr ? <div className='color-red font-size-14'>Enter Valid Number</div> : null
                                            }
                                        </div>
                                    </div>
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                            ...
                                            {
                                                anotherMobileValidNoErr ? <div className='color-red font-size-14'>Enter Valid Number</div> : null
                                            }
                                        </div>
                                    </div>
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                            ...
                                            {
                                                whatsappValidNoErr ? <div className='color-red font-size-14'>Enter Valid Number</div> : null
                                            }
                                        </div>
                                    </div>
                                    ...
                                    <div className='col-sm-4'>
                                        <div className='mt-2'>
                                            ...
                                            <div className='mt-2'>
                                                <input type='date' className={`form-control input-border-blue ${dateOfBirthErr ? "error-fill" : ""}`} value={dateOfBirth} onChange={(e) => { setDateOfBirth(e.target.value) }} max={moment().format("YYYY-MM-DD")} />
                                            </div>
                                            {
                                ...
                                <div className='mt-2'>
                                    ...
                                    {
                                        descriptionLenghtErr ? <span className='color-red font-size-14'>Please Input 25 to 225 Characters .</span>  : null
                                    }
                                </div>
